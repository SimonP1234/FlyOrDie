...
// FOR WINDOWS TESTING SIMO
#include <string.h>
#include <stddef.h>

// -----------------------------------------------------------------------------
//  Cross-platform fallback for missing string helpers on Windows/MSYS
// -----------------------------------------------------------------------------

#if defined(_WIN32) || defined(_WIN64) || defined(__MINGW32__) || defined(__MINGW64__)

// Windows toolchains (MSYS/MinGW) do NOT provide strlcpy/stpcpy in <string.h>
// Linux and macOS do — so we define local versions only for Windows builds.
